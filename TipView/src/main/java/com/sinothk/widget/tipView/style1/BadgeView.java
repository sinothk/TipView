package com.sinothk.widget.tipView.style1;
...
import com.sinothk.widget.tipView.R;

/**
 * 来自：https://github.com/Dsiner/UIUtil
 */
...
public class BadgeView extends TextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        color = typedArray.getColor(R.styleable.lib_pub_BadgeView_lib_pub_badgev_color, Color.RED);
